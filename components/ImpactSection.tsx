      ...
      <div className="max-w-[1440px] mx-auto px-6 mb-20" ref={containerRef}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-0 items-center justify-center text-center">
          {stats.map((stat, index) => (
            <div key={stat.id} className={`flex flex-col items-center relative ${index !== stats.length - 1 ? 'md:after:content-[""] md:after:absolute md:after:right-0 md:after:top-1/2 md:after:-translate-y-1/2 md:after:w-px md:after:h-20 md:after:bg-gradient-to-b md:after:from-transparent md:after:via-stone-700 md:after:to-transparent' : ''
              }`}>
